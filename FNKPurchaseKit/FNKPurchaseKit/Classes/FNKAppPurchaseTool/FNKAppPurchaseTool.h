//
//  FNKAppPurchaseTool.h
//  AppStoreToolDemo
//
//  Created by LWW on 16/8/24.
//  Copyright © 2020年 Frank. All rights reserved.
//

#import <Foundation/Foundation.h>
#import <StoreKit/StoreKit.h>

#pragma mark --------FNKAppPurchaseToolDelegate--内购代理
/**
 *  内购工具的代理
 */
@protocol FNKAppPurchaseToolDelegate <NSObject>
...
#pragma mark --------FNKAppPurchaseTool--内购工具
/**
 *  内购工具
 */
@interface FNKAppPurchaseTool : NSObject
 ...
 *  代理
 */
@property(nonatomic,weak) id <FNKAppPurchaseToolDelegate> delegate;
 ...
 *  单例
 *
 *  @return FNKAppPurchaseTool
 */
+(FNKAppPurchaseTool *)defaultTool;
