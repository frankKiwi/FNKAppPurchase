...
@interface FNKAppPurchaseTool ()<SKPaymentTransactionObserver,SKProductsRequestDelegate>
...
@implementation FNKAppPurchaseTool


//单例
static FNKAppPurchaseTool *storeTool;

//单例
+(FNKAppPurchaseTool *)defaultTool{
    if(!storeTool){
        storeTool = [FNKAppPurchaseTool new];
        [storeTool setup];
    }
    return storeTool;
}
